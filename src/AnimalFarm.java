...
public class AnimalFarm {
	...
	AnimalFarm() {
		...
		int animal = JOptionPane.showOptionDialog(null, "Which animal would you like?", "Animals!!!", 0,
				JOptionPane.INFORMATION_MESSAGE, null, new String[] { "Cow", "Duck", "Dog","Llama" }, null);
